...
public class CalendarWidget extends TableLayout 
 {
	...
	public void checkForCurrentData(CalendarCell calendarCell) {
		// TODO Auto-generated method stub
		Calendar cal = Calendar.getInstance();
		if((cal.get(Calendar.MONTH) == (m_page.mgr.GetCurrentMonth() + 2))  || (cal.get(Calendar.MONTH) == (m_page.mgr.GetCurrentMonth() - 10)))
		{
			if(Integer.parseInt(calendarCell.date.getText().toString()) == cal.get(Calendar.DAY_OF_MONTH))
			{
				//calendarCell.setBackgroundColor(Color.YELLOW);
				calendarCell.setBackgroundResource(R.drawable.current_date);
				return;
			}
		}
